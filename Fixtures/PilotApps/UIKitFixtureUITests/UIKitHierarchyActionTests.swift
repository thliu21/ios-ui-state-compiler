...
@MainActor
final class UIKitHierarchyActionTests: XCTestCase {
  func testHomeToDetailProducesStructuredEvidence() throws {
    ...
    try attachJSON(
      [
        ...
        "pair_id": "uikit-home-to-detail",
        "before_record_id": "paired-uikit-home",
        "after_record_id": "paired-uikit-detail-after-home-action",
        "action_type": "tap",
  ...
  func testDetailInitialStateProducesStructuredEvidence() throws {
    try captureInitialState(
      ...
      appearance: "light",
      locale: "zh-Hans",
      artifactPrefix: "uikit-detail-zh-Hans-light"
    )
  }
  ...
  func testFormInitialStateProducesStructuredEvidence() throws {
    try captureInitialState(
      ...
      appearance: "dark",
      locale: "en",
      artifactPrefix: "uikit-form-en-dark"
    )
  }
  ...
  func testModalInitialStateProducesStructuredEvidence() throws {
    try captureInitialState(
      ...
      appearance: "dark",
      locale: "zh-Hans",
      artifactPrefix: "uikit-modal-zh-Hans-dark"
    )
  }
  ...
  func testLongListInitialStateProducesStructuredEvidence() throws {
    try captureInitialState(
      ...
      appearance: "light",
      locale: "en",
      artifactPrefix: "uikit-long-list-en-light"
    )
  }
